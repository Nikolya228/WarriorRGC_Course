...
protected:
	virtual void ToogleCurrentEquippedWeaponCollision(bool bShouldEnable);
	virtual void ToogleBodyCollisionBoxCollision(bool bShouldEnable, EToogleDamageType ToogleDamageType);
