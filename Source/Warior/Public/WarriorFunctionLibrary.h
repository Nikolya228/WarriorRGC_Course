 ...
 */
UCLASS()
class WARIOR_API UWarriorFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Warrior|FunctionLibrary")
	static FGameplayTag ComputeHitReactDirectonTag(AActor* InAttacker, AActor* InVictim, float& AngleDiffence);

	UFUNCTION(BlueprintPure, Category = "Warrior|FunctionLibrary")
	static bool IsValidBlock(AActor* InAttacker, AActor* InDefender);

	UFUNCTION(BlueprintCallable, Category = "Warrior|FunctionLibrary")
	static bool ApplyGameplayEffectSpecHandleToTargetActor(AActor* Instigator, AActor* InTargetActor, const FGameplayEffectSpecHandle& InSpecHandle);
	...
	static void ToogleInputMode(const UObject* WorldContextObject, EWarriorInputMode InInputMode);
};
