...
AWarriorEnemyBaseCharacter::AWarriorEnemyBaseCharacter()
{
	...
	LeftHandCollisionBox = CreateDefaultSubobject<UBoxComponent>(TEXT("LeftHandCollisiionBox"));
...
UPawnUIComponent* AWarriorEnemyBaseCharacter::GetPawnUIComponent() const
{
	return EnemyUIComponent;
}

UEnemyUIComponent* AWarriorEnemyBaseCharacter::GetEnemyUIComponent() const
{
	return EnemyUIComponent;
}

void AWarriorEnemyBaseCharacter::BeginPlay()
{
	Super::BeginPlay();
...
#if WITH_EDITOR
void AWarriorEnemyBaseCharacter::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void AWarriorEnemyBaseCharacter::OnBodyCollisionBoxBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
