...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	GetAvailableActorsArroundTarget(ActorsOnLeft, ActorsOnRight);
...
void UHeroGameplayAbility_TargetLock::GetAvailableActorsToLock()
{
	...
	UKismetSystemLibrary::BoxTraceMultiForObjects(
		...
		false,
		TArray<AActor*>(),
		bShowPersistantDebugShape ? EDrawDebugTrace::Persistent : EDrawDebugTrace::None,
		BoxTraceHits,
		true
	);
...
void UHeroGameplayAbility_TargetLock::GetAvailableActorsArroundTarget(TArray<AActor*>& OutActorsOnLeft, TArray<AActor*>& OutActorsOnRight)
{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	...
	{
		checkf(TargetLockWidgetClass, TEXT("Forgot to assign a valid wadget class in blueprint"));
...
void UHeroGameplayAbility_TargetLock::SetTargetLockWidgetPosition()
{
	...
	if (TargetLockWidgetSize == FVector2D::ZeroVector)
	{
		DrawnTargetLockWidget->WidgetTree->ForEachWidget(
			...
			{
				if (USizeBox* FoundedSizeBox = Cast<USizeBox>(FoundWidget))
				{
					TargetLockWidgetSize.X = FoundedSizeBox->GetWidthOverride();
					TargetLockWidgetSize.Y = FoundedSizeBox->GetHeightOverride();
				}
			}
		);
	}	
...
void UHeroGameplayAbility_TargetLock::InitTargetLockMapingContext()
{
